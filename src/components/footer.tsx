          ...
          <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
            <div>
              ...
              <ul className="mt-6 space-y-1">
                ...
                <li>
                  <Link className="text-gray-700 transition hover:text-gray-700/75" href="/guides">
                    Guides Pratiques
                  </Link>
                </li>
                <li>
                  <Link className="text-gray-700 transition hover:text-gray-700/75" href="/recherche">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-1">
                ...
                <li>
                  <Link className="text-gray-700 transition hover:text-gray-700/75" href="/team">
                    L&apos;Équipe
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-1">
                ...
                <li>
                  <Link className="text-gray-700 transition hover:text-gray-700/75" href="/mentions-legales">
                    Mentions Légales
                  </Link>
                </li>
              </ul>
