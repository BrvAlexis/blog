    ...
    <section className="py-20 bg-white">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <h2>Les 4 clés pour vivre plus longtemps en bonne santé</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-center">Alimentation Optimale</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-center">Sommeil Réparateur</h3>
            <p className="text-gray-600 text-center">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-center">Activité Physique</h3>
            <p className="text-gray-600 text-center">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-center">Gestion du Stress</h3>
            <p className="text-gray-600 text-center">
